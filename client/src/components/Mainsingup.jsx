    ...
    <div className="box" style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "80vh" }}>
        ...
        <h1 className='text-3xl font-bold text-white' style={{marginBottom:"25px"}}>Create an account</h1>
            <form className='flex justify-center flex-col gap-5'>
                <input name="fullname"  style={{ width: "300px" }} placeholder="Enter full name" className="input" type="text" />
                <input name="email"  style={{ width: "300px" }} value="skrijwan@gmail.com" placeholder="Enter email" className="input" type="email" readOnly />
                <input name="password"  style={{ width: "300px" }} placeholder="Enter password" className="input" type="password" />
                <input name="repassword"  style={{ width: "300px" }} placeholder="conform password" className="input" type="password" />
